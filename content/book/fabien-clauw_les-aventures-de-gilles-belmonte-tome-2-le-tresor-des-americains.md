...
<%= quote_markup(
  text: "Jubilatoire ! Un vrai régal de lecture de bout en bout.",
  author: "Librairie Le Gang de la clef à molette"
) %>

<%= quote_markup(
  text: "Un nouveau Patrick O'Brian.",
  author: "Livres Hebdo"
) %>

<%= quote_markup(
  text: "Une grande fresque d'aventures historiques !",
  author: "Librairie Les Fables d'Olonne"
) %>

<%= quote_markup(
  text: "Une saga prometteuse qui arrive comme une revanche depuis bien longtemps espérée.",
  author: "Association des Officiers de Réserve de la Marine Nationale"
) %>