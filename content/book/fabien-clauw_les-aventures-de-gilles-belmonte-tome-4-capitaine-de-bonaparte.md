...
<%= quote_markup(
  text: "On ouvre les livres de Fabien Clauw comme on prend une place de cinéma.",
  author: "Sud-Ouest Dimanche"
) %>

<%= quote_markup(
  text: "Pour les lecteurs que son style absorbe littéralement, au point de les intégrer à l'équipage, l'expérience est toujours aussi vivifiante et impressionnante. À découvrir absolument !",
  author: "La Provence"
) %>

<%= quote_markup(
  text: "De l'aventure ! Et de la pêchue, excitante et exotique !",
  author: "L'Express"
) %>
